...
class CoverCarouselPage extends StatelessWidget {
  const CoverCarouselPage({super.key});

  static PageRoute route() =>
      MaterialPageRoute(builder: (context) => const CoverCarouselPage());

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(title: const Text('Coverflow')),
...
class CoverFlowCarouselView extends StatefulWidget {
  const CoverFlowCarouselView({super.key, this.style = CoverFlowStyle.none});
