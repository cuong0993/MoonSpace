...
import 'package:example/flutter_custom_carousel/views/wooha.dart';
...
class _ExampleCard extends StatelessWidget {
  const _ExampleCard({Key? key, required this.example, this.selected = false})
    : super(key: key);
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const Spacer(),
            if (selected)
              Align(alignment: Alignment.bottomRight, child: _buildTryBtn()),
          ],
        ),
      ),
    );
  ...
  void _goto(BuildContext context, _ExampleData example) {
    Navigator.of(context).push(MaterialPageRoute(builder: example.builder));
  }
