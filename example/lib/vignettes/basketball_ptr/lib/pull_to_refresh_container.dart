    ...
    _scaleAnimation = TweenSequence<double>([
      TweenSequenceItem(
        tween: Tween<double>(begin: 0.5, end: 0.0).chain(
          CurveTween(
            curve: ElasticOutCurve(0.65),
          ).chain(Tween<double>(begin: 0.0, end: 0.5)),
        ),
        weight: 2.0,
      ),
      TweenSequenceItem(
  ...
  Widget build(context) {
    ...
    List<Widget> children = <Widget>[
      ...
      Positioned(
        ...
        child: Image(
          image: AssetImage('assets/backboard.png', package: BasketballPtr.pkg),
        ),
      ),
      Positioned(
        ...
        width: netWidth,
        child: Image(
          image: AssetImage('assets/net.png', package: BasketballPtr.pkg),
        ),
      ),
      Positioned(
        ...
        width: rimWidth,
        child: Image(
          image: AssetImage('assets/rim.png', package: BasketballPtr.pkg),
        ),
      ),
    ];

    children.insert(
      _controller.value > 0.28 ? 2 : 4,
