...
class _SpinningBasketballState extends State<SpinningBasketball>
  ...
  void initState() {
    ...
    _spriteAnimation = TweenSequence<double>([
      TweenSequenceItem(tween: Tween<double>(begin: 0.0, end: 19.0), weight: 2),
      TweenSequenceItem(
    ...
    _yAnimation = TweenSequence<double>([
      ...
      TweenSequenceItem(
        tween: Tween<double>(begin: -0.72, end: 0.02).chain(
          CurveTween(
            curve: SineCurve(start: -math.pi / 2, length: math.pi),
          ),
        ),
        weight: 0.7,
      ),
      TweenSequenceItem(tween: ConstantTween<double>(0.02), weight: 4.00),
      TweenSequenceItem(
        tween: Tween<double>(
          begin: 0.02,
          end: 0.30,
  ...
  Widget build(context) {
    ...
    return Positioned(
      left:
          _xAnimation.value * 160 * ScalingInfo.scaleX +
          appSize.width / 2 -
          scaledWidth / 2,
      ...
      child: AnimatedSprite(
        image: AssetImage('assets/basketball.png', package: BasketballPtr.pkg),
        frameWidth: 400,
        frameHeight: 400,
