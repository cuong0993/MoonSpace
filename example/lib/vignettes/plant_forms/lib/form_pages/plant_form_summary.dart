...
import 'package:example/vignettes/plant_forms/lib/demo_data.dart';
...
class PlantFormSummary extends StatelessWidget {
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: AssetImage(
                    'images/plant_header_background.png',
  ...
  Widget _buildOrderSpecialInstructions(BuildContext context) {
    ...
    SharedFormState sharedState = Provider.of<SharedFormState>(
      context,
      listen: false,
    );
