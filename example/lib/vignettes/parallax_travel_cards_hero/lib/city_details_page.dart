    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return DefaultTextStyle(
          ...
          child: CityScenery(city: city, animationValue: heroAnimation.value),
        );
      },
    );
  }
          ...
          Column(
            children: <Widget>[
              Padding(
                ...
                child: Text(
                  'Experiences for every interest'.toUpperCase(),
          ...
          children: <Widget>[
            ...
            Container(
              child: Padding(
                ...
                child: Text(experience, style: Styles.detailsCardTitle),
              ),
            ),
          ],
        ),
