...
class FlightSummary extends StatelessWidget {
  ...
  Widget _buildSeparationLine() {
    return Container(width: double.infinity, height: 1, color: separatorColor);
  }
  ...
  Widget _buildTicketDuration() {
    ...
    final planeImage = Image.asset(
      'images/airplane_$routeType.png',
      height: 20,
      fit: BoxFit.contain,
      package: TicketFoldApp.pkg,
    );
        ...
        children: <Widget>[
          Container(
            ...
            child: Stack(
              ...
              children: <Widget>[
                Image.asset(
                  'images/planeroute_$routeType.png',
                  fit: BoxFit.cover,
                  package: TicketFoldApp.pkg,
                ),
                isLight
  ...
  Widget _buildBottomIcon() {
    IconData icon = isLight
        ? Icons.keyboard_arrow_down
        : Icons.keyboard_arrow_up;
    return Icon(icon, color: mainTextColor, size: 18);
  }
}
