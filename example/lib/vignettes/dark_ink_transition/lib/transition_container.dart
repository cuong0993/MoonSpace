...
import 'package:example/vignettes/_shared/ui/widget_mask.dart';
...
class _TransitionContainerState extends State<TransitionContainer>
  ...
  late Animation<double> _animation = TweenSequence(<TweenSequenceItem<double>>[
  ...
  ImageProvider _image = AssetImage(
    ...
    return LayoutBuilder(
      builder: (_, constraints) {
        ...
        List<Widget> children = <Widget>[
          Container(width: width, height: height, child: _childBackground),
        ];
