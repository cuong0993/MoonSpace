...
class _Indie3dHomeState extends State<Indie3dHome>
  ...
  Widget build(context) {
    if (!_controller.initialized) {
      precacheImage(
        AssetImage('images/artist_1.png', package: Indie3D.pkg),
        context,
      );
      precacheImage(
        AssetImage('images/artist_2.png', package: Indie3D.pkg),
        context,
      );
      precacheImage(
        AssetImage('images/artist_3.png', package: Indie3D.pkg),
        context,
      );
      precacheImage(
        AssetImage('images/noise.png', package: Indie3D.pkg),
        context,
      );
    ...
    return SafeArea(
      child: Scaffold(
        body: Stack(
          children: [
            GestureDetector(onTapUp: _handleTap, child: _buildPages()),
            IndieAppBar(),
            Align(
    ...
    switch (index) {
      case 0:
        result = Indie3dPage(
          ...
          image: AssetImage('images/artist_1.png', package: Indie3D.pkg),
          pageIndex: 0,
      ...
      case 1:
        result = Indie3dPage(
          ...
          image: AssetImage('images/artist_2.png', package: Indie3D.pkg),
          pageIndex: 1,
          controller: _controller,
      ...
      default:
        result = Indie3dPage(
          ...
          image: AssetImage('images/artist_3.png', package: Indie3D.pkg),
          pageIndex: 2,
          controller: _controller,
