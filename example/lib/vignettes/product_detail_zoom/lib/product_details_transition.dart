...
class _SpeakerAttribute extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    double lineHeight = Tween<double>(
      begin: 0,
      end: this.lineHeight,
      ...
      children: <Widget>[
        ...
        Positioned(
          ...
          child: Transform.rotate(
            angle: pi / 2,
            child: Container(width: lineHeight, height: 1, color: Colors.white),
          ),
        ),
        Positioned(
          top: lineHeight + 17,
          ...
          child: FadeTransition(
            ...
            child: CustomPaint(
              painter: CirclePainter(radius: 3, color: Colors.white),
            ),
          ),
        ),
      ],
