...
class _ProductDetailZoomDemoState extends State<ProductDetailZoomDemo>
  ...
  late AnimationController _transitionAnimController = AnimationController(
    vsync: this,
  ...
  Widget _buildBuyNowButton() {
    return MaterialButton(
      ...
      child: Text('Buy Now \$349.95'.toUpperCase(), style: bodyStyle),
    );
  }
  ...
  Widget _buildLearnMoreButton() {
    return MaterialButton(
      ...
      child: Text('Learn More'.toUpperCase(), style: bodyStyle),
    );
  }
  ...
  void _handleOnPressed() async {
    ...
    _transitionAnimController.forward().whenComplete(
      () => _transitionAnimController.reset(),
    );
    ...
    Navigator.push(
      context,
      FadeColorPageRoute(color: Colors.black, enterPage: ProductDetailView()),
    );
