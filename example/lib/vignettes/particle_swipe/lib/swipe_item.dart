...
import 'package:example/vignettes/_shared/physics/constrained_scroll_physics.dart';
...
class SwipeItemState extends State<SwipeItem> {
  ...
  Widget build(BuildContext context) {
    ...
    final double swipeRatio = math.min(
      1.0,
      _swipeDistance.abs() / SwipeItem.swipeDistance,
    );
